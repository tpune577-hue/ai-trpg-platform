        ...
        return (
            <div className="flex h-screen items-center justify-center bg-slate-950 text-white">
                <div className="text-center">
                    ...
                    <p className="text-slate-400">You must be an approved seller to view this page.</p>
                    <Link href="/seller/register" className="mt-4 inline-block text-amber-500 hover:underline">Register as Seller</Link>
                </div>
            </div>
        )
    }
