-- CreateEnum
CREATE TYPE "ProductType" AS ENUM ('DIGITAL_ASSET', 'LIVE_SESSION');

-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('USER', 'GM', 'ADMIN');
...
CREATE TABLE "MarketplaceItem" (
    ...
    "imageUrl" TEXT,
    "type" "ProductType" NOT NULL DEFAULT 'DIGITAL_ASSET',
...
CREATE TABLE "SellerProfile" (
    ...
    "bankName" TEXT,
    "bankAccount" TEXT,
    "status" TEXT NOT NULL DEFAULT 'PRE_REGISTER',
    "rejectReason" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Booking" ADD CONSTRAINT "Booking_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "MarketplaceItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;
